...
a1e.onclick = () => { sendMove("a1"); bxevents(a1, a1l, a1e); };
window.boardHandlers["a1"] = () => bxevents(a1, a1l, a1e);

a2e.onclick = () => { sendMove("a2"); bxevents(a2, a2l, a2e); };
window.boardHandlers["a2"] = () => bxevents(a2, a2l, a2e);

a3e.onclick = () => { sendMove("a3"); bxevents(a3, a3l, a3e); };
window.boardHandlers["a3"] = () => bxevents(a3, a3l, a3e);

a4e.onclick = () => { sendMove("a4"); bxevents(a4, a4l, a4e); };
window.boardHandlers["a4"] = () => bxevents(a4, a4l, a4e);

a5e.onclick = () => { sendMove("a5"); bxevents(a5, a5l, a5e); };
window.boardHandlers["a5"] = () => bxevents(a5, a5l, a5e);

a6e.onclick = () => { sendMove("a6"); bxevents(a6, a6l, a6e); };
window.boardHandlers["a6"] = () => bxevents(a6, a6l, a6e);

a7e.onclick = () => { sendMove("a7"); bxevents(a7, a7l, a7e); };
window.boardHandlers["a7"] = () => bxevents(a7, a7l, a7e);

a8e.onclick = () => { sendMove("a8"); bxevents(a8, a8l, a8e); };
window.boardHandlers["a8"] = () => bxevents(a8, a8l, a8e);


// Row B
b1e.onclick = () => { sendMove("b1"); bxevents(b1, b1l, b1e); };
window.boardHandlers["b1"] = () => bxevents(b1, b1l, b1e);

b2e.onclick = () => { sendMove("b2"); bxevents(b2, b2l, b2e); };
window.boardHandlers["b2"] = () => bxevents(b2, b2l, b2e);

b3e.onclick = () => { sendMove("b3"); bxevents(b3, b3l, b3e); };
window.boardHandlers["b3"] = () => bxevents(b3, b3l, b3e);

b4e.onclick = () => { sendMove("b4"); bxevents(b4, b4l, b4e); };
window.boardHandlers["b4"] = () => bxevents(b4, b4l, b4e);

b5e.onclick = () => { sendMove("b5"); bxevents(b5, b5l, b5e); };
window.boardHandlers["b5"] = () => bxevents(b5, b5l, b5e);

b6e.onclick = () => { sendMove("b6"); bxevents(b6, b6l, b6e); };
window.boardHandlers["b6"] = () => bxevents(b6, b6l, b6e);

b7e.onclick = () => { sendMove("b7"); bxevents(b7, b7l, b7e); };
window.boardHandlers["b7"] = () => bxevents(b7, b7l, b7e);

b8e.onclick = () => { sendMove("b8"); bxevents(b8, b8l, b8e); };
window.boardHandlers["b8"] = () => bxevents(b8, b8l, b8e);


// Row C
c1e.onclick = () => { sendMove("c1"); bxevents(c1, c1l, c1e); };
window.boardHandlers["c1"] = () => bxevents(c1, c1l, c1e);

c2e.onclick = () => { sendMove("c2"); bxevents(c2, c2l, c2e); };
window.boardHandlers["c2"] = () => bxevents(c2, c2l, c2e);

c3e.onclick = () => { sendMove("c3"); bxevents(c3, c3l, c3e); };
window.boardHandlers["c3"] = () => bxevents(c3, c3l, c3e);

c4e.onclick = () => { sendMove("c4"); bxevents(c4, c4l, c4e); };
window.boardHandlers["c4"] = () => bxevents(c4, c4l, c4e);

c5e.onclick = () => { sendMove("c5"); bxevents(c5, c5l, c5e); };
window.boardHandlers["c5"] = () => bxevents(c5, c5l, c5e);

c6e.onclick = () => { sendMove("c6"); bxevents(c6, c6l, c6e); };
window.boardHandlers["c6"] = () => bxevents(c6, c6l, c6e);

c7e.onclick = () => { sendMove("c7"); bxevents(c7, c7l, c7e); };
window.boardHandlers["c7"] = () => bxevents(c7, c7l, c7e);

c8e.onclick = () => { sendMove("c8"); bxevents(c8, c8l, c8e); };
window.boardHandlers["c8"] = () => bxevents(c8, c8l, c8e);


// Row D
d1e.onclick = () => { sendMove("d1"); bxevents(d1, d1l, d1e); };
window.boardHandlers["d1"] = () => bxevents(d1, d1l, d1e);

d2e.onclick = () => { sendMove("d2"); bxevents(d2, d2l, d2e); };
window.boardHandlers["d2"] = () => bxevents(d2, d2l, d2e);

d3e.onclick = () => { sendMove("d3"); bxevents(d3, d3l, d3e); };
window.boardHandlers["d3"] = () => bxevents(d3, d3l, d3e);

d4e.onclick = () => { sendMove("d4"); bxevents(d4, d4l, d4e); };
window.boardHandlers["d4"] = () => bxevents(d4, d4l, d4e);

d5e.onclick = () => { sendMove("d5"); bxevents(d5, d5l, d5e); };
window.boardHandlers["d5"] = () => bxevents(d5, d5l, d5e);

d6e.onclick = () => { sendMove("d6"); bxevents(d6, d6l, d6e); };
window.boardHandlers["d6"] = () => bxevents(d6, d6l, d6e);

d7e.onclick = () => { sendMove("d7"); bxevents(d7, d7l, d7e); };
window.boardHandlers["d7"] = () => bxevents(d7, d7l, d7e);

d8e.onclick = () => { sendMove("d8"); bxevents(d8, d8l, d8e); };
window.boardHandlers["d8"] = () => bxevents(d8, d8l, d8e);


// Row E
e1e.onclick = () => { sendMove("e1"); bxevents(e1, e1l, e1e); };
window.boardHandlers["e1"] = () => bxevents(e1, e1l, e1e);

e2e.onclick = () => { sendMove("e2"); bxevents(e2, e2l, e2e); };
window.boardHandlers["e2"] = () => bxevents(e2, e2l, e2e);

e3e.onclick = () => { sendMove("e3"); bxevents(e3, e3l, e3e); };
window.boardHandlers["e3"] = () => bxevents(e3, e3l, e3e);

e4e.onclick = () => { sendMove("e4"); bxevents(e4, e4l, e4e); };
window.boardHandlers["e4"] = () => bxevents(e4, e4l, e4e);

e5e.onclick = () => { sendMove("e5"); bxevents(e5, e5l, e5e); };
window.boardHandlers["e5"] = () => bxevents(e5, e5l, e5e);

e6e.onclick = () => { sendMove("e6"); bxevents(e6, e6l, e6e); };
window.boardHandlers["e6"] = () => bxevents(e6, e6l, e6e);

e7e.onclick = () => { sendMove("e7"); bxevents(e7, e7l, e7e); };
window.boardHandlers["e7"] = () => bxevents(e7, e7l, e7e);

e8e.onclick = () => { sendMove("e8"); bxevents(e8, e8l, e8e); };
window.boardHandlers["e8"] = () => bxevents(e8, e8l, e8e);


// Row F
f1e.onclick = () => { sendMove("f1"); bxevents(f1, f1l, f1e); };
window.boardHandlers["f1"] = () => bxevents(f1, f1l, f1e);

f2e.onclick = () => { sendMove("f2"); bxevents(f2, f2l, f2e); };
window.boardHandlers["f2"] = () => bxevents(f2, f2l, f2e);

f3e.onclick = () => { sendMove("f3"); bxevents(f3, f3l, f3e); };
window.boardHandlers["f3"] = () => bxevents(f3, f3l, f3e);

f4e.onclick = () => { sendMove("f4"); bxevents(f4, f4l, f4e); };
window.boardHandlers["f4"] = () => bxevents(f4, f4l, f4e);

f5e.onclick = () => { sendMove("f5"); bxevents(f5, f5l, f5e); };
window.boardHandlers["f5"] = () => bxevents(f5, f5l, f5e);

f6e.onclick = () => { sendMove("f6"); bxevents(f6, f6l, f6e); };
window.boardHandlers["f6"] = () => bxevents(f6, f6l, f6e);

f7e.onclick = () => { sendMove("f7"); bxevents(f7, f7l, f7e); };
window.boardHandlers["f7"] = () => bxevents(f7, f7l, f7e);

f8e.onclick = () => { sendMove("f8"); bxevents(f8, f8l, f8e); };
window.boardHandlers["f8"] = () => bxevents(f8, f8l, f8e);


// Row G
g1e.onclick = () => { sendMove("g1"); bxevents(g1, g1l, g1e); };
window.boardHandlers["g1"] = () => bxevents(g1, g1l, g1e);

g2e.onclick = () => { sendMove("g2"); bxevents(g2, g2l, g2e); };
window.boardHandlers["g2"] = () => bxevents(g2, g2l, g2e);

g3e.onclick = () => { sendMove("g3"); bxevents(g3, g3l, g3e); };
window.boardHandlers["g3"] = () => bxevents(g3, g3l, g3e);

g4e.onclick = () => { sendMove("g4"); bxevents(g4, g4l, g4e); };
window.boardHandlers["g4"] = () => bxevents(g4, g4l, g4e);

g5e.onclick = () => { sendMove("g5"); bxevents(g5, g5l, g5e); };
window.boardHandlers["g5"] = () => bxevents(g5, g5l, g5e);

g6e.onclick = () => { sendMove("g6"); bxevents(g6, g6l, g6e); };
window.boardHandlers["g6"] = () => bxevents(g6, g6l, g6e);

g7e.onclick = () => { sendMove("g7"); bxevents(g7, g7l, g7e); };
window.boardHandlers["g7"] = () => bxevents(g7, g7l, g7e);

g8e.onclick = () => { sendMove("g8"); bxevents(g8, g8l, g8e); };
window.boardHandlers["g8"] = () => bxevents(g8, g8l, g8e);


// Row H
h1e.onclick = () => { sendMove("h1"); bxevents(h1, h1l, h1e); };
window.boardHandlers["h1"] = () => bxevents(h1, h1l, h1e);

h2e.onclick = () => { sendMove("h2"); bxevents(h2, h2l, h2e); };
window.boardHandlers["h2"] = () => bxevents(h2, h2l, h2e);

h3e.onclick = () => { sendMove("h3"); bxevents(h3, h3l, h3e); };
window.boardHandlers["h3"] = () => bxevents(h3, h3l, h3e);

h4e.onclick = () => { sendMove("h4"); bxevents(h4, h4l, h4e); };
window.boardHandlers["h4"] = () => bxevents(h4, h4l, h4e);

h5e.onclick = () => { sendMove("h5"); bxevents(h5, h5l, h5e); };
window.boardHandlers["h5"] = () => bxevents(h5, h5l, h5e);

h6e.onclick = () => { sendMove("h6"); bxevents(h6, h6l, h6e); };
window.boardHandlers["h6"] = () => bxevents(h6, h6l, h6e);

h7e.onclick = () => { sendMove("h7"); bxevents(h7, h7l, h7e); };
window.boardHandlers["h7"] = () => bxevents(h7, h7l, h7e);

h8e.onclick = () => { sendMove("h8"); bxevents(h8, h8l, h8e); };
window.boardHandlers["h8"] = () => bxevents(h8, h8l, h8e);
